...
//   down: boolean;
//   moved: boolean;
//   color: Color; // Changed from number[] to Color
// }
...
//     const pointers = [
//       new (pointerPrototype as unknown as { new (): PointerPrototype })(),
//     ];
...
//       gl.uniform1f(splatProgram.uniforms.alpha, 0.5); // Set alpha for transparency
//       blit(dye.write);
//       dye.swap();
//     }
